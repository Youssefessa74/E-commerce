...
class VendorWithDrawDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($query) {
            $edit = "<a href='" . route('admin.with-draws.edit', $query->id) . "' class='btn btn-primary'><i class='fas fa-edit'></i></a>";
            $delete = "
                        <form action='" . route('admin.with-draws.destroy', $query->id) . "' method='POST' style='display:inline;' onsubmit='return confirm(\"Are you sure?\");'>
                            " . csrf_field() . "
                            " . method_field('DELETE') . "
            ...
            ->setRowId('id')
            ->rawColumns(['withdraw_charge','action']);
    }

    /**
     * Get the query source of dataTable.
     */
    public function query(VendorWithDraw $model): QueryBuilder
    {
