@php
    ...
    $footerInfo = Cache::rememberForever('footerInfo', function () {
       return App\Models\FooterInfo::first();
     });
    $footerSocials = Cache::rememberForever('footerSocials', function () {
        ...
        <div class="row justify-content-between">
            <div class="col-xl-3 col-sm-7 col-md-6 col-lg-3">
                <div class="wsus__footer_content">
                    ...
                    <ul class="wsus__footer_social">
                        ...
                        <li><a class="{{ $item->name }}" href="{{ url($item->url) }}"><i class="{{ $item->icon }}"></i></a></li>
                        @endforeach
            ...
            <div class="col-xl-4 col-sm-7 col-md-8 col-lg-5">
                <div class="wsus__footer_content wsus__footer_content_2">
                    ...
                    <form id="newsletters_subscribe">
                        @csrf
                        <input type="text" name="email" placeholder="sazao@gmail.com">
