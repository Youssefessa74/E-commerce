                        ...
                        <div class="wsus__pro_page_bammer_text wsus__vendor_det_banner_text">
                            <div class="wsus__vendor_text_center">
                                ...
                                <ul class="d-flex">
                                    ...
                                    @if(!empty($vendor->whatsapp_link))
                                        <li><a class="whatsapp" href="{{ $vendor->whatsapp_link }}"><i class="fab fa-whatsapp"></i></a></li>
                                    @endif
                                            ...
                                            "
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    <a class="wsus__pro_name"
                                                        href="#">{{ limitText($product->name, 52) }}</a>
                                                    @if (checkDiscount($product))
                                                        <p class="wsus__price">
                                                    ...
                                                    @else
                                                        <p class="wsus__price">
                                                            {{ $settings->currency_icon }}{{ $product->price }}</del></p>
                                                    @endif
