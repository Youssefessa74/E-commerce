...
<div class="card border">
    <div class="card-body">
        <form action="{{ route('admin.update.product.banner') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                <img src="{{asset(@$productpage_banner_section->product_banner->banner_image)}}" alt="" width="150px">
            </div>
            <div class="form-group">

                <label>Banner Image</label>
                <input type="file" class="form-control" name="banner_image" value="">
                <input type="hidden" class="form-control" name="banner_old_image" value="{{@$productpage_banner_section->product_banner->banner_image}}">
            </div>
            <div class="form-group">
