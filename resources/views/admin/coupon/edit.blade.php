                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.coupon.update',$coupon->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="max_use_per_person" value="{{ $coupon->max_use_per_person }}">
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="discount_type" id="inputState" class="form-control">
                                                    ...
                                                    <option @selected($coupon->discount_type == 'amount') value="amount">Amount ({{ $settings->currency_icon }})</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="inputState" class="form-control">
                                            ...
                                            <option  @selected($coupon->status == 0) value="0">In Active</option>
                                        </select>
                                    </div>
