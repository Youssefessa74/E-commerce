...
@section('title')
    WithDraw Requests | {{ $request->vendor->shop_name }}
@endsection
@section('content')
 ...
 <section class="section">
    <div class="section-header">
      ...
      <a href="{{ route('admin.with-draw-requests.index') }}" class="btn btn-primary ml-2">return</a>
    </div>
      ...
      <div class="section-body">
        <div class="invoice">
          <div class="invoice-print">
            <div class="row mt-4">
              <div class="col-md-4">
                  <form action="{{ route('admin.with.draw.request.status', $request->id) }}" method="POST">
                      @csrf
                      @method('PUT')
